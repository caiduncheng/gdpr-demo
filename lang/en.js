module.exports = {
  ...
  home: {
    ...
    lifecycle: {
      ...
      deployment: {
        ...
        detail2:
          "The device can bind the Installation Template in batches,this sets up the pre-installation environment to reduce repetitive labor",
      ...
      multi_dimen: {
        ...
        detail4:
          "Not only can be set in batches, but also can be specific to a single device operation, both convenient and accurate",
      },
      software: {
        title: "Software",
  ...
  flykey: {
    ...
    feature1_list_item2: "Upload and store keys in secure enviroment",
