module.exports = {
  ...
  login: {
    otp: {
      congratulations: '现在你可以用 OTP 登录',
      your_2fa_secret: '你的双因素密钥',
      take_1m: '这只需要一小会',
      take_1m_tip: `立即启用 2FA。 之后可以继续您的工作。`,
      tfa_why: `双因素身份验证(2FA)为账户增加了额外一层的安全。 这是一个经过验证的
      确保您免受黑客和帐户盗用的方法，即使您的密码被盗或泄露。`,
      tfa_what_forms: `我们使用什么形式的 2FA？`,
      tfa_what: `支持<b>TOTP</b> 的验证器应用<p> 基于时间的一次性密码 (TOTP) 是一种计算机算法，可生成使用当前时间作为唯一性来源的一次性密码 (OTP)。 </p>`,
      enable_2fa_now: '立即启用 2FA',
      enable_2fa: '启用双因素身份验证 (2FA)',
      open_otp_tip: "需要二次验证（Two-Factor Authentication ）绑定，请输入以下信息发送邮箱验证码",
      setup_authenticator_app: "设置验证器应用",
      app_intro: `
      安装验证器应用或者浏览器插件，例如 <a href="https://authy.com/download/" target="_blank" style="text-decoration: underline;">Authy</a>, <a href="https://www.microsoft.com/en-US/security/mobile-authenticator-app" target="_blank" style="text-decoration: underline;">Microsoft Authenticator</a>, <a href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2" target="_blank" style="text-decoration: underline;">Google Authenticator</a>等。当你登录的时候生成用作验证您身份的第二个因素的一次性密码.`,
      scan_qrcode: "扫描二维码",
      scan_qrcode_tip: "使用验证器应用或者浏览器插件扫描",
      unalbe_scan_qrcode: "无法扫码？你可以用密钥在验证器应用中手动添加",
      manual: '手动添加',
      verify_code: "测试验证器生成的验证码",
      verify: "验证"
    },
    otp_info: `当前账号要求开启双因素身份验证(2FA)`,
    reject_reason: "拒绝原因",
    send:"发送邮件",
    verification_code: "验证码",
    email_code_tip: "一封电子邮件已发送到您的收件箱。 请检查您的电子邮件以完成验证。",
    download_auth_tip: "请扫描二维码下载验证器.",
    download_auth_tip1: `你可以使用其他支持<span style="color:#3E80E5">TOTP </span> (基于时间一次性密码)的验证器, 例如 <span style="color:#3E80E5"> Google Authenticator, Microsoft Authenticator</span>, 和 <span style="color:#3E80E5">Authy</span>. 如果无法下载，请在应用市场中搜索 <span style="color:#3E80E5"> Authenticator</span> 选择合适的应用.`,
    bind_otp_tip: " 请通过验证器扫描二维码创建动态密码",
    bind_otp2_tip: "请尽可能不要向任何人透露您收到的二维码，这可能会损害您的帐户安全",
    tofa: '双因素身份验证',
    reject_reason: '拒绝原因',
    welcome: "欢迎！",
    slogan: "摒弃繁杂，拥抱世界！",
    ...
    validate_otp_required: "验证码不能为空",
    validate_email_token_required: "邮箱验证码不能为空",
    ...
    agree_terms_conditions_ndp:
      '我同意 <a class="link" target="_blank" href="/privacy/privacy-policy"> Privacy Policy </a>,<a class="link" target="_blank" href="/privacy/terms"> Terms & Conditions</a>,<a class="link" target="_blank" href="/privacy/distribution"> Distribution Policy </a> 和 <a class="link" target="_blank" href="/privacy/services"> Terms of Services</a>',
