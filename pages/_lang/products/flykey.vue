<template>
  <div class="flykey">
    ...
    <div class="background-wrapper">
      <div class="h-full w-full flykey-background"></div>
    </div>
    <div class="flykey-main">
...
.flykey {
  ...
  .section-2 {
    background-image: url("~assets/FLYKEY/05.png");
    p,
    ul {
      color: #6c6c6c;
    }
