            ...
            <div class="col-xl-6 col-lg-8 col-md-10">
              ...
              <div class="text-white mb-8 signup-title" v-else-if="step === 2">
                <div style="display: flex; align-items: center;">
                  <h3 class="hover:text-blue-400 cursor-pointer" style="flex: 0 0 50px ; " @click="backHandle()">
              ...
              <div v-if="step === 1">
                <div class="flex role-choose">
                  ...
                  <div class="col-md-6 col-sm-8 p-4">
                    ...
                    >
                      <img
                        src="~assets/sign-up/operator.png"
                        width="100px"
                        class="mt-10 mb-9"
                      />
                  ...
                  <div class="col-md-6 col-sm-8 p-4">
                    ...
                    >
                      <img
                        src="~assets/sign-up/developer.png"
                        width="80px"
                        class="mt-8 mb-7"
                      />
                  ...
                  >
                      ...
                      <div class="flex-1">
                        ...
                        >
                          <el-input
                            ...
                            @blur="
                              () =>
                                (operatorForm.name = operatorForm.name.trim())
                            "
                            :maxlength="128"
                          ></el-input>
                        </el-form-item>
                        ...
                        >
                          <el-input
                            :maxlength="32"
                            v-model="operatorForm.contactName"
                            @blur="
                              () =>
                                (operatorForm.contactName =
                                  operatorForm.contactName.trim())
                            "
                          ></el-input>
                        </el-form-item>
                        <el-form-item
                        ...
                        >
                          <el-input
                            v-model.trim="operatorForm.mobile"
                            :maxlength="16"
                          ></el-input>
                        </el-form-item>
                        <el-form-item
                    ...
                    <div class="flex">
                      ...
                      <div class="flex-1">
                        ...
                        >
                          <el-input
                            v-model="operatorForm.confirmPassword"
                            type="password"
                          ></el-input>
                        </el-form-item>
                        <hr class="my-6" />
                  ...
                  >
                    ...
                    >
                      <el-input
                        ...
                        @blur="
                          () =>
                            (developerForm.firstName =
                              developerForm.firstName.trim())
                        "
                      ></el-input>
                    </el-form-item>
                    <el-form-item
                    ...
                    >
                      <el-input
                        ...
                        @blur="
                          () =>
                            (developerForm.lastName =
                              developerForm.lastName.trim())
                        "
                      ></el-input>
                    </el-form-item>
                    ...
                    >
                      <el-input
                        ...
                        @blur="
                          () =>
                            (developerForm.contactName =
                              developerForm.contactName.trim())
                        "
                      ></el-input>
                    </el-form-item>
                    <el-form-item
                    ...
                    >
                      <el-input
                        v-model.trim="developerForm.mobile"
                        :maxlength="16"
                      ></el-input>
                    </el-form-item>
                    <el-form-item
                    ...
                    <div class="flex-1">
                      ...
                      >
                        <el-input
                          v-model="developerForm.confirmPassword1"
                          type="password"
                        ></el-input>
                      </el-form-item>
                      <hr class="my-6" />
